...
1. **Tests the supported engine range** — the `engine_ref` matrix (currently `v0.1.95` and `v0.2.4`), cloning gen1recomp at each, live-mounting the mod, and running the headless suite.
